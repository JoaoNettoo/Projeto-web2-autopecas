...
class PecaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Peca
        fields = ['id', 'nome', 'codigo_sku', 'marca', 'modelo_veiculo', 'categoria', 'preco', 'estoque', 'descricao', 'fornecedor', 'fornecedor_id', 'criado_em']
...
class PedidoSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        for item in itens_data:
            ...
            ItemPedido.objects.create(pedido=pedido, peca=peca, quantidade=quantidade, preco_unitario=preco_unitario)
            total += float(preco_unitario) * int(quantidade)
